...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Temperatur.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{TemperaturMotor.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{TemperaturController.jpg}
